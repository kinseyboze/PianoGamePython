...
class Piano:
    ...
    def create_keys(self):
        ...
        for i in range(14):  # C to B
            rect = pygame.Rect((i * white_key_width) + 100, 500, white_key_width, white_key_height)
        ...
        for i in range(14):
            if i not in skip:
                rect = pygame.Rect(((i + 1) * white_key_width - black_key_width // 2) + 100, 500, black_key_width, black_key_height)
